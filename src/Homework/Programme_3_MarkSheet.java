...
public class Programme_3_MarkSheet {
    public static void main(String[] args) {
        ...
        if (mathsMarks < 0 || mathsMarks > 100) {
            System.out.println("\nInvalid input, Marks shoukd be between 0 to 100");
            System.out.println("\nplese enter correct marks\t\t:\t");
            mathsMarks = scanner.nextInt();
        }
        System.out.println("Enter Marks of Subject Science\t:t");
        int scienceMark = scanner.nextInt();
        if (scienceMark < 0 || scienceMark > 100) {
            System.out.println("nInvalid input, Marks should be between 0 to 100");
            System.out.println("\nplese enter correct marks\t\t:\t");
        ...
        int total = sum(mathsMarks, scienceMark, englishMarks);
        int percentage = (total * 100) / 300;
        String result = calculateResult(mathsMarks, scienceMark, englishMarks);
        String grade = calculateGrade(percentage, result);
        printTheMarkSheet(name, rollNum, mathsMarks, scienceMark, englishMarks, total, percentage, result, grade);
    ...
    // Calculating the grade on percentage adn result
